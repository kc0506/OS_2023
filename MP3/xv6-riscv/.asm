...
void thrdstop_handler_resume_main_id(void *arg)
{
    ...
    thrdresume(main_id);  // jump to line 23
      ...
      10:	0e478793          	addi	a5,a5,228 # 20f0 <main_id>
      14:	439c                	lw	a5,0(a5)
      16:	853e                	mv	a0,a5
...
int test_multi_context()
{
    ...
    if (v2 == 77) {
      ...
      7c:	08878793          	addi	a5,a5,136 # 2100 <v2.1>
      80:	439c                	lw	a5,0(a5)
      82:	873e                	mv	a4,a5
    ...
    while (v1 == 0) {
      ...
      f2:	01678793          	addi	a5,a5,22 # 2104 <v1.0>
      f6:	439c                	lw	a5,0(a5)
...
int main(int argc, char **argv)
{
    ...
    fprintf(2, "[%s] %s\n", result ? "FAILED" : "OK", "test_multi_context");
     ...
     15e:	df678793          	addi	a5,a5,-522 # 1f50 <schedule_rm+0x216>
     162:	a029                	j	16c <main+0x3a>
     164:	00002797          	auipc	a5,0x2
     168:	df478793          	addi	a5,a5,-524 # 1f58 <schedule_rm+0x21e>
     16c:	00002697          	auipc	a3,0x2
     170:	df468693          	addi	a3,a3,-524 # 1f60 <schedule_rm+0x226>
     174:	863e                	mv	a2,a5
     176:	00002597          	auipc	a1,0x2
     17a:	e0258593          	addi	a1,a1,-510 # 1f78 <schedule_rm+0x23e>
     17e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     78a:	93268693          	addi	a3,a3,-1742 # 20b8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     864:	85870713          	addi	a4,a4,-1960 # 20b8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a24:	56878793          	addi	a5,a5,1384 # 1f88 <schedule_rm+0x24e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bd0:	54c78793          	addi	a5,a5,1356 # 2118 <freep>
     bd4:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cc8:	45478793          	addi	a5,a5,1108 # 2118 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d4a:	3d278793          	addi	a5,a5,978 # 2118 <freep>
     d4e:	639c                	ld	a5,0(a5)
}
     d50:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d7c:	3a078793          	addi	a5,a5,928 # 2118 <freep>
     d80:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d90:	37c78793          	addi	a5,a5,892 # 2108 <base>
     d94:	fef43023          	sd	a5,-32(s0)
     d98:	00001797          	auipc	a5,0x1
     d9c:	38078793          	addi	a5,a5,896 # 2118 <freep>
     da0:	fe043703          	ld	a4,-32(s0)
     da4:	e398                	sd	a4,0(a5)
     da6:	00001797          	auipc	a5,0x1
     daa:	37278793          	addi	a5,a5,882 # 2118 <freep>
     dae:	6398                	ld	a4,0(a5)
     db0:	00001797          	auipc	a5,0x1
     db4:	35878793          	addi	a5,a5,856 # 2108 <base>
     db8:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     dba:	00001797          	auipc	a5,0x1
     dbe:	34e78793          	addi	a5,a5,846 # 2108 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e3a:	2e278793          	addi	a5,a5,738 # 2118 <freep>
    ...
    if(p == freep)
     ...
     e50:	2cc78793          	addi	a5,a5,716 # 2118 <freep>
     e54:	639c                	ld	a5,0(a5)
...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
     ...
     fd8:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd848>
     fdc:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
     fde:	fe843783          	ld	a5,-24(s0)
     fe2:	00200737          	lui	a4,0x200
     fe6:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd948>
     fea:	e798                	sd	a4,8(a5)
}
     fec:	0001                	nop
...
void thread_add_at(struct thread *t, int arrival_time) {
    ...
    1148:	f9c58593          	addi	a1,a1,-100 # 20e0 <release_queue>
    114c:	853e                	mv	a0,a5
...
void __release() {
    ...
    116c:	f7878793          	addi	a5,a5,-136 # 20e0 <release_queue>
    ...
    11a0:	f8c78793          	addi	a5,a5,-116 # 2128 <threading_system_time>
    ...
    11e2:	ef258593          	addi	a1,a1,-270 # 20d0 <run_queue>
    11e6:	853e                	mv	a0,a5
    ...
    1234:	eb078793          	addi	a5,a5,-336 # 20e0 <release_queue>
...
void __thread_exit(struct thread *to_remove) {
    ...
    125e:	ec678793          	addi	a5,a5,-314 # 2120 <current>
    ...
    12a6:	e5678793          	addi	a5,a5,-426 # 20f8 <main_thrd_id>
...
void thread_exit(void) {
    ...
    12cc:	e5878793          	addi	a5,a5,-424 # 2120 <current>
    12d0:	6398                	ld	a4,0(a5)
    12d2:	00001797          	auipc	a5,0x1
    12d6:	dfe78793          	addi	a5,a5,-514 # 20d0 <run_queue>
    ...
    12e2:	cb258593          	addi	a1,a1,-846 # 1f90 <schedule_rm+0x256>
    12e6:	4509                	li	a0,2
    ...
    12fe:	e2678793          	addi	a5,a5,-474 # 2120 <current>
...
void __finish_current() {
    ...
    1374:	db078793          	addi	a5,a5,-592 # 2120 <current>
    ...
    13a6:	d8678793          	addi	a5,a5,-634 # 2128 <threading_system_time>
    ...
    13ba:	c1250513          	addi	a0,a0,-1006 # 1fc8 <schedule_rm+0x28e>
...
void switch_handler(void *arg) {  // arg = allocated time
    ...
    1444:	ce078793          	addi	a5,a5,-800 # 2120 <current>
    ...
    1466:	cc678793          	addi	a5,a5,-826 # 2128 <threading_system_time>
    ...
    147a:	cb278793          	addi	a5,a5,-846 # 2128 <threading_system_time>
    ...
    14b2:	c7a78793          	addi	a5,a5,-902 # 2128 <threading_system_time>
    ...
    14c6:	c6678793          	addi	a5,a5,-922 # 2128 <threading_system_time>
    ...
    14e4:	c4878793          	addi	a5,a5,-952 # 2128 <threading_system_time>
    14e8:	439c                	lw	a5,0(a5)
    14ea:	863e                	mv	a2,a5
    14ec:	85ba                	mv	a1,a4
    14ee:	00001517          	auipc	a0,0x1
    14f2:	b1250513          	addi	a0,a0,-1262 # 2000 <schedule_rm+0x2c6>
    ...
    1536:	bc678793          	addi	a5,a5,-1082 # 20f8 <main_thrd_id>
...
void __dispatch() {
    ...
    155c:	bc878793          	addi	a5,a5,-1080 # 2120 <current>
    1560:	6398                	ld	a4,0(a5)
    1562:	00001797          	auipc	a5,0x1
    1566:	b6e78793          	addi	a5,a5,-1170 # 20d0 <run_queue>
    ...
    1572:	bb278793          	addi	a5,a5,-1102 # 2120 <current>
    ...
    158c:	ba878793          	addi	a5,a5,-1112 # 2130 <allocated_time>
    ...
    15a8:	a5c50513          	addi	a0,a0,-1444 # 2000 <schedule_rm+0x2c6>
    ...
    15c8:	b6478793          	addi	a5,a5,-1180 # 2128 <threading_system_time>
    15cc:	4390                	lw	a2,0(a5)
    15ce:	00001797          	auipc	a5,0x1
    15d2:	b6278793          	addi	a5,a5,-1182 # 2130 <allocated_time>
    15d6:	639c                	ld	a5,0(a5)
    15d8:	86be                	mv	a3,a5
    15da:	85ba                	mv	a1,a4
    15dc:	00001517          	auipc	a0,0x1
    15e0:	a4c50513          	addi	a0,a0,-1460 # 2028 <schedule_rm+0x2ee>
    ...
    15f8:	b3c78793          	addi	a5,a5,-1220 # 2130 <allocated_time>
    ...
    160e:	b2678793          	addi	a5,a5,-1242 # 2130 <allocated_time>
    ...
    1658:	adc78793          	addi	a5,a5,-1316 # 2130 <allocated_time>
    ...
    166e:	ac678793          	addi	a5,a5,-1338 # 2130 <allocated_time>
    ...
    1696:	9c658593          	addi	a1,a1,-1594 # 2058 <schedule_rm+0x31e>
    169a:	4509                	li	a0,2
...
void __schedule(void) {
    ...
    16e4:	a4878793          	addi	a5,a5,-1464 # 2128 <threading_system_time>
    16e8:	439c                	lw	a5,0(a5)
    16ea:	fcf42c23          	sw	a5,-40(s0)
    16ee:	00001797          	auipc	a5,0x1
    16f2:	9e278793          	addi	a5,a5,-1566 # 20d0 <run_queue>
    16f6:	fef43023          	sd	a5,-32(s0)
    16fa:	00001797          	auipc	a5,0x1
    16fe:	9e678793          	addi	a5,a5,-1562 # 20e0 <release_queue>
    ...
    1728:	616080e7          	jalr	1558(ra) # 1d3a <schedule_rm>
    172c:	872a                	mv	a4,a0
    172e:	87ae                	mv	a5,a1
...
void back_to_main_handler(void *arg) {
    ...
    1770:	9c078793          	addi	a5,a5,-1600 # 212c <sleeping>
    ...
    1784:	9a878793          	addi	a5,a5,-1624 # 2128 <threading_system_time>
    ...
    1798:	99478793          	addi	a5,a5,-1644 # 2128 <threading_system_time>
    179c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    179e:	00001797          	auipc	a5,0x1
    17a2:	95a78793          	addi	a5,a5,-1702 # 20f8 <main_thrd_id>
...
void thread_start_threading() {
    ...
    17c8:	96478793          	addi	a5,a5,-1692 # 2128 <threading_system_time>
    17cc:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    17d0:	00001797          	auipc	a5,0x1
    17d4:	95078793          	addi	a5,a5,-1712 # 2120 <current>
    17d8:	00001717          	auipc	a4,0x1
    17dc:	8f870713          	addi	a4,a4,-1800 # 20d0 <run_queue>
    ...
    17f0:	90c58593          	addi	a1,a1,-1780 # 20f8 <main_thrd_id>
    ...
    1804:	8f878793          	addi	a5,a5,-1800 # 20f8 <main_thrd_id>
    ...
    182c:	8d078793          	addi	a5,a5,-1840 # 20f8 <main_thrd_id>
    ...
    184a:	88a50513          	addi	a0,a0,-1910 # 20d0 <run_queue>
    ...
    185e:	88650513          	addi	a0,a0,-1914 # 20e0 <release_queue>
    ...
    1872:	8c278793          	addi	a5,a5,-1854 # 2130 <allocated_time>
    1876:	639c                	ld	a5,0(a5)
    1878:	85be                	mv	a1,a5
    187a:	00001517          	auipc	a0,0x1
    187e:	81650513          	addi	a0,a0,-2026 # 2090 <schedule_rm+0x356>
    1882:	fffff097          	auipc	ra,0xfffff
    1886:	2e6080e7          	jalr	742(ra) # b68 <printf>
        sleeping = 1;
    188a:	00001797          	auipc	a5,0x1
    188e:	8a278793          	addi	a5,a5,-1886 # 212c <sleeping>
    1892:	4705                	li	a4,1
    ...
    189a:	89a78793          	addi	a5,a5,-1894 # 2130 <allocated_time>
    189e:	639c                	ld	a5,0(a5)
    18a0:	0007871b          	sext.w	a4,a5
    18a4:	00001797          	auipc	a5,0x1
    18a8:	88c78793          	addi	a5,a5,-1908 # 2130 <allocated_time>
    ...
    18bc:	84058593          	addi	a1,a1,-1984 # 20f8 <main_thrd_id>
    18c0:	853a                	mv	a0,a4
    ...
    18f0:	7f450513          	addi	a0,a0,2036 # 20e0 <release_queue>
...
00000000000019f8 <get_missed_thread>:

struct thread *get_missed_thread(struct threads_sched_args args) {
    19f8:	7179                	addi	sp,sp,-48
    19fa:	f422                	sd	s0,40(sp)
    19fc:	f026                	sd	s1,32(sp)
    19fe:	1800                	addi	s0,sp,48
    1a00:	84aa                	mv	s1,a0
    struct thread *th = NULL;
    1a02:	fe043423          	sd	zero,-24(s0)
    struct thread *res = NULL;
    1a06:	fe043023          	sd	zero,-32(s0)

    // first check for missed threads
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a0a:	649c                	ld	a5,8(s1)
    1a0c:	639c                	ld	a5,0(a5)
    1a0e:	fcf43c23          	sd	a5,-40(s0)
    1a12:	fd843783          	ld	a5,-40(s0)
    1a16:	fd878793          	addi	a5,a5,-40
    1a1a:	fef43423          	sd	a5,-24(s0)
    1a1e:	a089                	j	1a60 <get_missed_thread+0x68>
        if (th->current_deadline <= args.current_time) {
    1a20:	fe843783          	ld	a5,-24(s0)
    1a24:	4bb8                	lw	a4,80(a5)
    1a26:	409c                	lw	a5,0(s1)
    1a28:	02e7c163          	blt	a5,a4,1a4a <get_missed_thread+0x52>
            if (res == NULL || res->ID > th->ID)
    1a2c:	fe043783          	ld	a5,-32(s0)
    1a30:	cb89                	beqz	a5,1a42 <get_missed_thread+0x4a>
    1a32:	fe043783          	ld	a5,-32(s0)
    1a36:	5398                	lw	a4,32(a5)
    1a38:	fe843783          	ld	a5,-24(s0)
    1a3c:	539c                	lw	a5,32(a5)
    1a3e:	00e7d663          	bge	a5,a4,1a4a <get_missed_thread+0x52>
                res = th;
    1a42:	fe843783          	ld	a5,-24(s0)
    1a46:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a4a:	fe843783          	ld	a5,-24(s0)
    1a4e:	779c                	ld	a5,40(a5)
    1a50:	fcf43823          	sd	a5,-48(s0)
    1a54:	fd043783          	ld	a5,-48(s0)
    1a58:	fd878793          	addi	a5,a5,-40
    1a5c:	fef43423          	sd	a5,-24(s0)
    1a60:	fe843783          	ld	a5,-24(s0)
    1a64:	02878713          	addi	a4,a5,40
    1a68:	649c                	ld	a5,8(s1)
    1a6a:	faf71be3          	bne	a4,a5,1a20 <get_missed_thread+0x28>
        }
    }
    ...
    1a72:	853e                	mv	a0,a5
    1a74:	7422                	ld	s0,40(sp)
    1a76:	7482                	ld	s1,32(sp)
    1a78:	6145                	addi	sp,sp,48
    1a7a:	8082                	ret

0000000000001a7c <check_run_queue_empty>:

int check_run_queue_empty(struct threads_sched_args args, struct threads_sched_result *r) {
    1a7c:	715d                	addi	sp,sp,-80
    1a7e:	e486                	sd	ra,72(sp)
    1a80:	e0a2                	sd	s0,64(sp)
    1a82:	fc26                	sd	s1,56(sp)
    1a84:	0880                	addi	s0,sp,80
    1a86:	84aa                	mv	s1,a0
    1a88:	fab43c23          	sd	a1,-72(s0)
    if (!list_empty(args.run_queue))
    1a8c:	649c                	ld	a5,8(s1)
    1a8e:	853e                	mv	a0,a5
    1a90:	00000097          	auipc	ra,0x0
    1a94:	e7e080e7          	jalr	-386(ra) # 190e <list_empty>
    1a98:	87aa                	mv	a5,a0
    1a9a:	e399                	bnez	a5,1aa0 <check_run_queue_empty+0x24>
        return 0;
    1a9c:	4781                	li	a5,0
    1a9e:	a849                	j	1b30 <check_run_queue_empty+0xb4>

    struct release_queue_entry *cur;
    int earliest_ddl = -1;
    1aa0:	57fd                	li	a5,-1
    1aa2:	fcf42a23          	sw	a5,-44(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1aa6:	689c                	ld	a5,16(s1)
    1aa8:	639c                	ld	a5,0(a5)
    1aaa:	fcf43423          	sd	a5,-56(s0)
    1aae:	fc843783          	ld	a5,-56(s0)
    1ab2:	17e1                	addi	a5,a5,-8
    1ab4:	fcf43c23          	sd	a5,-40(s0)
    1ab8:	a0b1                	j	1b04 <check_run_queue_empty+0x88>
        if (earliest_ddl == -1)
    1aba:	fd442783          	lw	a5,-44(s0)
    1abe:	0007871b          	sext.w	a4,a5
    1ac2:	57fd                	li	a5,-1
    1ac4:	00f71763          	bne	a4,a5,1ad2 <check_run_queue_empty+0x56>
            earliest_ddl = cur->release_time;
    1ac8:	fd843783          	ld	a5,-40(s0)
    1acc:	4f9c                	lw	a5,24(a5)
    1ace:	fcf42a23          	sw	a5,-44(s0)
        earliest_ddl = (earliest_ddl > cur->release_time) ? cur->release_time : earliest_ddl;
    1ad2:	fd843783          	ld	a5,-40(s0)
    1ad6:	4f9c                	lw	a5,24(a5)
    1ad8:	863e                	mv	a2,a5
    1ada:	fd442783          	lw	a5,-44(s0)
    1ade:	0007869b          	sext.w	a3,a5
    1ae2:	0006071b          	sext.w	a4,a2
    1ae6:	00d75363          	bge	a4,a3,1aec <check_run_queue_empty+0x70>
    1aea:	87b2                	mv	a5,a2
    1aec:	fcf42a23          	sw	a5,-44(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1af0:	fd843783          	ld	a5,-40(s0)
    1af4:	679c                	ld	a5,8(a5)
    1af6:	fcf43023          	sd	a5,-64(s0)
    1afa:	fc043783          	ld	a5,-64(s0)
    1afe:	17e1                	addi	a5,a5,-8
    1b00:	fcf43c23          	sd	a5,-40(s0)
    1b04:	fd843783          	ld	a5,-40(s0)
    1b08:	00878713          	addi	a4,a5,8
    1b0c:	689c                	ld	a5,16(s1)
    1b0e:	faf716e3          	bne	a4,a5,1aba <check_run_queue_empty+0x3e>
    }

    r->scheduled_thread_list_member = args.run_queue;
    1b12:	6498                	ld	a4,8(s1)
    1b14:	fb843783          	ld	a5,-72(s0)
    1b18:	e398                	sd	a4,0(a5)
    r->allocated_time = earliest_ddl - args.current_time;
    1b1a:	409c                	lw	a5,0(s1)
    1b1c:	fd442703          	lw	a4,-44(s0)
    1b20:	40f707bb          	subw	a5,a4,a5
    1b24:	0007871b          	sext.w	a4,a5
    1b28:	fb843783          	ld	a5,-72(s0)
    1b2c:	c798                	sw	a4,8(a5)
    return 1;
    1b2e:	4785                	li	a5,1
}
    1b30:	853e                	mv	a0,a5
    ...
    1b38:	6161                	addi	sp,sp,80
    1b3a:	8082                	ret

0000000000001b3c <schedule_edf>:
            }                                                  \
        }                                                      \
    } while (0);
...
struct threads_sched_result schedule_edf(struct threads_sched_args args) {
    1b3c:	7155                	addi	sp,sp,-208
    1b3e:	e586                	sd	ra,200(sp)
    1b40:	e1a2                	sd	s0,192(sp)
    1b42:	fd26                	sd	s1,184(sp)
    1b44:	f94a                	sd	s2,176(sp)
    1b46:	f54e                	sd	s3,168(sp)
    1b48:	0980                	addi	s0,sp,208
    1b4a:	84aa                	mv	s1,a0
    struct thread *res = NULL;
    1b4c:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1b50:	fc043023          	sd	zero,-64(s0)
    struct threads_sched_result r;

    res = get_missed_thread(args);
    1b54:	609c                	ld	a5,0(s1)
    1b56:	f2f43823          	sd	a5,-208(s0)
    1b5a:	649c                	ld	a5,8(s1)
    1b5c:	f2f43c23          	sd	a5,-200(s0)
    1b60:	689c                	ld	a5,16(s1)
    1b62:	f4f43023          	sd	a5,-192(s0)
    1b66:	f3040793          	addi	a5,s0,-208
    1b6a:	853e                	mv	a0,a5
    1b6c:	00000097          	auipc	ra,0x0
    1b70:	e8c080e7          	jalr	-372(ra) # 19f8 <get_missed_thread>
    1b74:	fca43423          	sd	a0,-56(s0)
    if (res)
    1b78:	fc843783          	ld	a5,-56(s0)
    1b7c:	cb91                	beqz	a5,1b90 <schedule_edf+0x54>
        return (struct threads_sched_result){
            .scheduled_thread_list_member = &res->thread_list,
    1b7e:	fc843783          	ld	a5,-56(s0)
    1b82:	02878793          	addi	a5,a5,40
        return (struct threads_sched_result){
    1b86:	f6f43823          	sd	a5,-144(s0)
    1b8a:	f6042c23          	sw	zero,-136(s0)
    1b8e:	a269                	j	1d18 <schedule_edf+0x1dc>
            .allocated_time = 0};

    // if not, find edf
    if (check_run_queue_empty(args, &r)) {
    1b90:	609c                	ld	a5,0(s1)
    1b92:	f2f43823          	sd	a5,-208(s0)
    1b96:	649c                	ld	a5,8(s1)
    1b98:	f2f43c23          	sd	a5,-200(s0)
    1b9c:	689c                	ld	a5,16(s1)
    1b9e:	f4f43023          	sd	a5,-192(s0)
    1ba2:	f6040713          	addi	a4,s0,-160
    1ba6:	f3040793          	addi	a5,s0,-208
    1baa:	85ba                	mv	a1,a4
    1bac:	853e                	mv	a0,a5
    1bae:	00000097          	auipc	ra,0x0
    1bb2:	ece080e7          	jalr	-306(ra) # 1a7c <check_run_queue_empty>
    1bb6:	87aa                	mv	a5,a0
    1bb8:	cb91                	beqz	a5,1bcc <schedule_edf+0x90>
        return r;
    1bba:	f6043783          	ld	a5,-160(s0)
    1bbe:	f6f43823          	sd	a5,-144(s0)
    1bc2:	f6843783          	ld	a5,-152(s0)
    1bc6:	f6f43c23          	sd	a5,-136(s0)
    1bca:	a2b9                	j	1d18 <schedule_edf+0x1dc>
    //             continue;
    //         res = th;
    //     }
    // }
    ...
    1bce:	639c                	ld	a5,0(a5)
    1bd0:	faf43423          	sd	a5,-88(s0)
    1bd4:	fa843783          	ld	a5,-88(s0)
    1bd8:	fd878793          	addi	a5,a5,-40
    1bdc:	fcf43023          	sd	a5,-64(s0)
    1be0:	a8a9                	j	1c3a <schedule_edf+0xfe>
    1be2:	fc843783          	ld	a5,-56(s0)
    1be6:	cb89                	beqz	a5,1bf8 <schedule_edf+0xbc>
    1be8:	fc043783          	ld	a5,-64(s0)
    1bec:	4bb8                	lw	a4,80(a5)
    1bee:	fc843783          	ld	a5,-56(s0)
    1bf2:	4bbc                	lw	a5,80(a5)
    1bf4:	02e7c863          	blt	a5,a4,1c24 <schedule_edf+0xe8>
    1bf8:	fc043783          	ld	a5,-64(s0)
    1bfc:	4bb8                	lw	a4,80(a5)
    1bfe:	fc843783          	ld	a5,-56(s0)
    1c02:	4bbc                	lw	a5,80(a5)
    1c04:	00f71a63          	bne	a4,a5,1c18 <schedule_edf+0xdc>
    1c08:	fc043783          	ld	a5,-64(s0)
    1c0c:	5398                	lw	a4,32(a5)
    1c0e:	fc843783          	ld	a5,-56(s0)
    1c12:	539c                	lw	a5,32(a5)
    1c14:	00e7c763          	blt	a5,a4,1c22 <schedule_edf+0xe6>
    1c18:	fc043783          	ld	a5,-64(s0)
    1c1c:	fcf43423          	sd	a5,-56(s0)
    1c20:	a011                	j	1c24 <schedule_edf+0xe8>
    1c22:	0001                	nop
    1c24:	fc043783          	ld	a5,-64(s0)
    1c28:	779c                	ld	a5,40(a5)
    1c2a:	f8f43023          	sd	a5,-128(s0)
    1c2e:	f8043783          	ld	a5,-128(s0)
    1c32:	fd878793          	addi	a5,a5,-40
    1c36:	fcf43023          	sd	a5,-64(s0)
    1c3a:	fc043783          	ld	a5,-64(s0)
    1c3e:	02878713          	addi	a4,a5,40
    1c42:	649c                	ld	a5,8(s1)
    1c44:	f8f71fe3          	bne	a4,a5,1be2 <schedule_edf+0xa6>

    int allo_time, end_time, max_end_time = res->remaining_time + args.current_time;
    1c48:	fc843783          	ld	a5,-56(s0)
    1c4c:	47f8                	lw	a4,76(a5)
    1c4e:	409c                	lw	a5,0(s1)
    1c50:	9fb9                	addw	a5,a5,a4
    1c52:	faf42223          	sw	a5,-92(s0)
    end_time = max_end_time;
    1c56:	fa442783          	lw	a5,-92(s0)
    1c5a:	faf42e23          	sw	a5,-68(s0)
    if (end_time > res->current_deadline)
    1c5e:	fc843783          	ld	a5,-56(s0)
    1c62:	4bb8                	lw	a4,80(a5)
    1c64:	fbc42783          	lw	a5,-68(s0)
    1c68:	2781                	sext.w	a5,a5
    1c6a:	00f75763          	bge	a4,a5,1c78 <schedule_edf+0x13c>
        end_time = res->current_deadline;
    1c6e:	fc843783          	ld	a5,-56(s0)
    1c72:	4bbc                	lw	a5,80(a5)
    1c74:	faf42e23          	sw	a5,-68(s0)

    struct release_queue_entry *cur;
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1c78:	689c                	ld	a5,16(s1)
    1c7a:	639c                	ld	a5,0(a5)
    1c7c:	f8f43c23          	sd	a5,-104(s0)
    1c80:	f9843783          	ld	a5,-104(s0)
    1c84:	17e1                	addi	a5,a5,-8
    1c86:	faf43823          	sd	a5,-80(s0)
    1c8a:	a0b9                	j	1cd8 <schedule_edf+0x19c>
        if (cur->release_time < end_time && cur->release_time + cur->thrd->period < res->current_deadline)
    1c8c:	fb043783          	ld	a5,-80(s0)
    1c90:	4f98                	lw	a4,24(a5)
    1c92:	fbc42783          	lw	a5,-68(s0)
    1c96:	2781                	sext.w	a5,a5
    1c98:	02f75663          	bge	a4,a5,1cc4 <schedule_edf+0x188>
    1c9c:	fb043783          	ld	a5,-80(s0)
    1ca0:	4f98                	lw	a4,24(a5)
    1ca2:	fb043783          	ld	a5,-80(s0)
    1ca6:	639c                	ld	a5,0(a5)
    1ca8:	43fc                	lw	a5,68(a5)
    1caa:	9fb9                	addw	a5,a5,a4
    1cac:	0007871b          	sext.w	a4,a5
    1cb0:	fc843783          	ld	a5,-56(s0)
    1cb4:	4bbc                	lw	a5,80(a5)
    1cb6:	00f75763          	bge	a4,a5,1cc4 <schedule_edf+0x188>
            end_time = cur->release_time;
    1cba:	fb043783          	ld	a5,-80(s0)
    1cbe:	4f9c                	lw	a5,24(a5)
    1cc0:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1cc4:	fb043783          	ld	a5,-80(s0)
    1cc8:	679c                	ld	a5,8(a5)
    1cca:	f8f43423          	sd	a5,-120(s0)
    1cce:	f8843783          	ld	a5,-120(s0)
    1cd2:	17e1                	addi	a5,a5,-8
    1cd4:	faf43823          	sd	a5,-80(s0)
    1cd8:	fb043783          	ld	a5,-80(s0)
    1cdc:	00878713          	addi	a4,a5,8
    1ce0:	689c                	ld	a5,16(s1)
    1ce2:	faf715e3          	bne	a4,a5,1c8c <schedule_edf+0x150>
    }
    allo_time = end_time - args.current_time;
    1ce6:	409c                	lw	a5,0(s1)
    1ce8:	fbc42703          	lw	a4,-68(s0)
    1cec:	40f707bb          	subw	a5,a4,a5
    1cf0:	f8f42a23          	sw	a5,-108(s0)

    r.scheduled_thread_list_member = &res->thread_list;
    1cf4:	fc843783          	ld	a5,-56(s0)
    1cf8:	02878793          	addi	a5,a5,40
    1cfc:	f6f43023          	sd	a5,-160(s0)
    r.allocated_time = allo_time;
    1d00:	f9442783          	lw	a5,-108(s0)
    1d04:	f6f42423          	sw	a5,-152(s0)

    return r;
    1d08:	f6043783          	ld	a5,-160(s0)
    1d0c:	f6f43823          	sd	a5,-144(s0)
    1d10:	f6843783          	ld	a5,-152(s0)
    1d14:	f6f43c23          	sd	a5,-136(s0)
}
    1d18:	f7043703          	ld	a4,-144(s0)
    1d1c:	f7843783          	ld	a5,-136(s0)
    1d20:	893a                	mv	s2,a4
    1d22:	89be                	mv	s3,a5
    1d24:	874a                	mv	a4,s2
    1d26:	87ce                	mv	a5,s3
    1d28:	853a                	mv	a0,a4
    1d2a:	85be                	mv	a1,a5
    1d2c:	60ae                	ld	ra,200(sp)
    1d2e:	640e                	ld	s0,192(sp)
    1d30:	74ea                	ld	s1,184(sp)
    1d32:	794a                	ld	s2,176(sp)
    1d34:	79aa                	ld	s3,168(sp)
    1d36:	6169                	addi	sp,sp,208
    1d38:	8082                	ret

0000000000001d3a <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args) {
    1d3a:	7155                	addi	sp,sp,-208
    1d3c:	e586                	sd	ra,200(sp)
    1d3e:	e1a2                	sd	s0,192(sp)
    1d40:	fd26                	sd	s1,184(sp)
    1d42:	f94a                	sd	s2,176(sp)
    1d44:	f54e                	sd	s3,168(sp)
    1d46:	0980                	addi	s0,sp,208
    1d48:	84aa                	mv	s1,a0
    struct thread *res = NULL;
    1d4a:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1d4e:	fc043023          	sd	zero,-64(s0)
    struct threads_sched_result r;

    // first try to find already missed thread
    res = get_missed_thread(args);
    1d52:	609c                	ld	a5,0(s1)
    1d54:	f2f43823          	sd	a5,-208(s0)
    1d58:	649c                	ld	a5,8(s1)
    1d5a:	f2f43c23          	sd	a5,-200(s0)
    1d5e:	689c                	ld	a5,16(s1)
    1d60:	f4f43023          	sd	a5,-192(s0)
    1d64:	f3040793          	addi	a5,s0,-208
    1d68:	853e                	mv	a0,a5
    1d6a:	00000097          	auipc	ra,0x0
    1d6e:	c8e080e7          	jalr	-882(ra) # 19f8 <get_missed_thread>
    1d72:	fca43423          	sd	a0,-56(s0)
    if (res)
    1d76:	fc843783          	ld	a5,-56(s0)
    1d7a:	cb91                	beqz	a5,1d8e <schedule_rm+0x54>
        return (struct threads_sched_result){
            .scheduled_thread_list_member = &res->thread_list,
    1d7c:	fc843783          	ld	a5,-56(s0)
    1d80:	02878793          	addi	a5,a5,40
        return (struct threads_sched_result){
    1d84:	f6f43823          	sd	a5,-144(s0)
    1d88:	f6042c23          	sw	zero,-136(s0)
    1d8c:	a24d                	j	1f2e <schedule_rm+0x1f4>
            .allocated_time = 0};

    // check if run_queue is empty
    // if so, return and sleep
    if (check_run_queue_empty(args, &r)) {
    1d8e:	609c                	ld	a5,0(s1)
    1d90:	f2f43823          	sd	a5,-208(s0)
    1d94:	649c                	ld	a5,8(s1)
    1d96:	f2f43c23          	sd	a5,-200(s0)
    1d9a:	689c                	ld	a5,16(s1)
    1d9c:	f4f43023          	sd	a5,-192(s0)
    1da0:	f6040713          	addi	a4,s0,-160
    1da4:	f3040793          	addi	a5,s0,-208
    1da8:	85ba                	mv	a1,a4
    1daa:	853e                	mv	a0,a5
    1dac:	00000097          	auipc	ra,0x0
    1db0:	cd0080e7          	jalr	-816(ra) # 1a7c <check_run_queue_empty>
    1db4:	87aa                	mv	a5,a0
    1db6:	cb91                	beqz	a5,1dca <schedule_rm+0x90>
        return r;
    1db8:	f6043783          	ld	a5,-160(s0)
    1dbc:	f6f43823          	sd	a5,-144(s0)
    1dc0:	f6843783          	ld	a5,-152(s0)
    1dc4:	f6f43c23          	sd	a5,-136(s0)
    1dc8:	a29d                	j	1f2e <schedule_rm+0x1f4>
    }

    get_thread_by_least(th, args.run_queue, period);
    1dca:	649c                	ld	a5,8(s1)
    1dcc:	639c                	ld	a5,0(a5)
    1dce:	faf43423          	sd	a5,-88(s0)
    1dd2:	fa843783          	ld	a5,-88(s0)
    1dd6:	fd878793          	addi	a5,a5,-40
    1dda:	fcf43023          	sd	a5,-64(s0)
    1dde:	a8a9                	j	1e38 <schedule_rm+0xfe>
    1de0:	fc843783          	ld	a5,-56(s0)
    1de4:	cb89                	beqz	a5,1df6 <schedule_rm+0xbc>
    1de6:	fc043783          	ld	a5,-64(s0)
    1dea:	43f8                	lw	a4,68(a5)
    1dec:	fc843783          	ld	a5,-56(s0)
    1df0:	43fc                	lw	a5,68(a5)
    1df2:	02e7c863          	blt	a5,a4,1e22 <schedule_rm+0xe8>
    1df6:	fc043783          	ld	a5,-64(s0)
    1dfa:	43f8                	lw	a4,68(a5)
    1dfc:	fc843783          	ld	a5,-56(s0)
    1e00:	43fc                	lw	a5,68(a5)
    1e02:	00f71a63          	bne	a4,a5,1e16 <schedule_rm+0xdc>
    1e06:	fc043783          	ld	a5,-64(s0)
    1e0a:	5398                	lw	a4,32(a5)
    1e0c:	fc843783          	ld	a5,-56(s0)
    1e10:	539c                	lw	a5,32(a5)
    1e12:	00e7c763          	blt	a5,a4,1e20 <schedule_rm+0xe6>
    1e16:	fc043783          	ld	a5,-64(s0)
    1e1a:	fcf43423          	sd	a5,-56(s0)
    1e1e:	a011                	j	1e22 <schedule_rm+0xe8>
    1e20:	0001                	nop
    1e22:	fc043783          	ld	a5,-64(s0)
    1e26:	779c                	ld	a5,40(a5)
    1e28:	f8f43023          	sd	a5,-128(s0)
    1e2c:	f8043783          	ld	a5,-128(s0)
    1e30:	fd878793          	addi	a5,a5,-40
    1e34:	fcf43023          	sd	a5,-64(s0)
    1e38:	fc043783          	ld	a5,-64(s0)
    1e3c:	02878713          	addi	a4,a5,40
    1e40:	649c                	ld	a5,8(s1)
    1e42:	f8f71fe3          	bne	a4,a5,1de0 <schedule_rm+0xa6>

    int allo_time, end_time, max_end_time = res->remaining_time + args.current_time;
    1e46:	fc843783          	ld	a5,-56(s0)
    1e4a:	47f8                	lw	a4,76(a5)
    1e4c:	409c                	lw	a5,0(s1)
    1e4e:	9fb9                	addw	a5,a5,a4
    1e50:	faf42223          	sw	a5,-92(s0)
    end_time = max_end_time;
    1e54:	fa442783          	lw	a5,-92(s0)
    1e58:	faf42e23          	sw	a5,-68(s0)
    if (end_time > res->current_deadline)
    1e5c:	fc843783          	ld	a5,-56(s0)
    1e60:	4bb8                	lw	a4,80(a5)
    1e62:	fbc42783          	lw	a5,-68(s0)
    1e66:	2781                	sext.w	a5,a5
    1e68:	00f75763          	bge	a4,a5,1e76 <schedule_rm+0x13c>
        end_time = res->current_deadline;
    1e6c:	fc843783          	ld	a5,-56(s0)
    1e70:	4bbc                	lw	a5,80(a5)
    1e72:	faf42e23          	sw	a5,-68(s0)

    struct release_queue_entry *cur;
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1e76:	689c                	ld	a5,16(s1)
    1e78:	639c                	ld	a5,0(a5)
    1e7a:	f8f43c23          	sd	a5,-104(s0)
    1e7e:	f9843783          	ld	a5,-104(s0)
    1e82:	17e1                	addi	a5,a5,-8
    1e84:	faf43823          	sd	a5,-80(s0)
    1e88:	a09d                	j	1eee <schedule_rm+0x1b4>
        if (cur->release_time < end_time) {
    1e8a:	fb043783          	ld	a5,-80(s0)
    1e8e:	4f98                	lw	a4,24(a5)
    1e90:	fbc42783          	lw	a5,-68(s0)
    1e94:	2781                	sext.w	a5,a5
    1e96:	04f75263          	bge	a4,a5,1eda <schedule_rm+0x1a0>
            if (cur->thrd->period < res->period ||
    1e9a:	fb043783          	ld	a5,-80(s0)
    1e9e:	639c                	ld	a5,0(a5)
    1ea0:	43f8                	lw	a4,68(a5)
    1ea2:	fc843783          	ld	a5,-56(s0)
    1ea6:	43fc                	lw	a5,68(a5)
    1ea8:	02f74463          	blt	a4,a5,1ed0 <schedule_rm+0x196>
                (cur->thrd->period == res->period && cur->thrd->ID < res->ID))
    1eac:	fb043783          	ld	a5,-80(s0)
    1eb0:	639c                	ld	a5,0(a5)
    1eb2:	43f8                	lw	a4,68(a5)
    1eb4:	fc843783          	ld	a5,-56(s0)
    1eb8:	43fc                	lw	a5,68(a5)
            if (cur->thrd->period < res->period ||
    1eba:	02f71063          	bne	a4,a5,1eda <schedule_rm+0x1a0>
                (cur->thrd->period == res->period && cur->thrd->ID < res->ID))
    1ebe:	fb043783          	ld	a5,-80(s0)
    1ec2:	639c                	ld	a5,0(a5)
    1ec4:	5398                	lw	a4,32(a5)
    1ec6:	fc843783          	ld	a5,-56(s0)
    1eca:	539c                	lw	a5,32(a5)
    1ecc:	00f75763          	bge	a4,a5,1eda <schedule_rm+0x1a0>
                end_time = cur->release_time;
    1ed0:	fb043783          	ld	a5,-80(s0)
    1ed4:	4f9c                	lw	a5,24(a5)
    1ed6:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1eda:	fb043783          	ld	a5,-80(s0)
    1ede:	679c                	ld	a5,8(a5)
    1ee0:	f8f43423          	sd	a5,-120(s0)
    1ee4:	f8843783          	ld	a5,-120(s0)
    1ee8:	17e1                	addi	a5,a5,-8
    1eea:	faf43823          	sd	a5,-80(s0)
    1eee:	fb043783          	ld	a5,-80(s0)
    1ef2:	00878713          	addi	a4,a5,8
    1ef6:	689c                	ld	a5,16(s1)
    1ef8:	f8f719e3          	bne	a4,a5,1e8a <schedule_rm+0x150>
        }
    }

    allo_time = end_time - args.current_time;
    1efc:	409c                	lw	a5,0(s1)
    1efe:	fbc42703          	lw	a4,-68(s0)
    1f02:	40f707bb          	subw	a5,a4,a5
    1f06:	f8f42a23          	sw	a5,-108(s0)

    r.scheduled_thread_list_member = &res->thread_list;
    1f0a:	fc843783          	ld	a5,-56(s0)
    1f0e:	02878793          	addi	a5,a5,40
    1f12:	f6f43023          	sd	a5,-160(s0)
    r.allocated_time = allo_time;
    1f16:	f9442783          	lw	a5,-108(s0)
    1f1a:	f6f42423          	sw	a5,-152(s0)

    return r;
    1f1e:	f6043783          	ld	a5,-160(s0)
    1f22:	f6f43823          	sd	a5,-144(s0)
    1f26:	f6843783          	ld	a5,-152(s0)
    1f2a:	f6f43c23          	sd	a5,-136(s0)
}
    1f2e:	f7043703          	ld	a4,-144(s0)
    1f32:	f7843783          	ld	a5,-136(s0)
    1f36:	893a                	mv	s2,a4
    1f38:	89be                	mv	s3,a5
    1f3a:	874a                	mv	a4,s2
    1f3c:	87ce                	mv	a5,s3
    1f3e:	853a                	mv	a0,a4
    1f40:	85be                	mv	a1,a5
    1f42:	60ae                	ld	ra,200(sp)
    1f44:	640e                	ld	s0,192(sp)
    1f46:	74ea                	ld	s1,184(sp)
    1f48:	794a                	ld	s2,176(sp)
    1f4a:	79aa                	ld	s3,168(sp)
    1f4c:	6169                	addi	sp,sp,208
    1f4e:	8082                	ret
